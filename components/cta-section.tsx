  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-16 text-center lg:px-8">
      <div className="glass rounded-[2rem] p-10 sm:p-16">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-content-secondary">{description ?? `Use the button below to visit ${product.name}. Replace this URL in the product JSON with your affiliate link.`}</p>
