...
function ReviewHeroImage({ product }: { product: Product }) { return <section className="mx-auto max-w-7xl px-6 pb-12 lg:px-8"><div className="glass overflow-hidden rounded-[2rem] p-3 shadow-2xl shadow-blue-950/30"><ScreenshotImage src={product.heroImage} alt={`${product.name} application screenshot`} width={1600} height={1000} sizes="(min-width: 1280px) 1200px, 100vw" className="rounded-[1.5rem] border border-white/10" /></div></section>; }
