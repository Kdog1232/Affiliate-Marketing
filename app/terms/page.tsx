...
export default function TermsPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-radial-brand">
      <div className="absolute inset-x-0 top-0 -z-0 h-96 bg-gradient-to-b from-brand/20 via-accent/10 to-transparent blur-3xl" />
      <div className="relative mx-auto max-w-5xl px-6 py-10 lg:px-8">
        ...
        <section className="py-16 text-center sm:py-20">
          <p className="text-sm font-semibold uppercase tracking-[.35em] text-brand-light">Legal information</p>
          <h1 className="mt-5 text-5xl font-bold tracking-tight text-content-primary sm:text-7xl">Terms of Service</h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-content-secondary">
            ...
            return (
              <article key={section.title} className="glass rounded-3xl p-6 sm:p-8">
                <div className="flex flex-col gap-4 sm:flex-row">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-brand/15 text-brand ring-1 ring-brand-light/20">
                    <Icon className="h-6 w-6" aria-hidden="true" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold tracking-tight text-content-primary">{section.title}</h2>
                    <div className="mt-4 space-y-4 text-base leading-7 text-content-secondary">
        ...
        <section className="my-10 rounded-3xl border border-brand-light/20 bg-gradient-to-br from-brand/20 via-surface/[.08] to-accent/10 p-6 shadow-2xl shadow-content-primary/20 backdrop-blur-xl sm:p-8">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[.3em] text-brand">Contact</p>
              <h2 className="mt-3 text-3xl font-bold text-content-primary">AIToolBet</h2>
              <a href="https://aitoolbet.com" className="mt-2 inline-flex text-content-secondary transition hover:text-content-primary">https://aitoolbet.com</a>
            </div>
            <a href="mailto:contact@aitoolbet.com" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-brand px-5 py-3 text-sm font-bold text-content-primary shadow-lg shadow-brand-dark/40 transition hover:bg-brand-light">
